...
namespace MGSE_Project
{
    class InputBox
    {
        ...
        public InputBox(Vector2 pos, Color color, int maxChars)
        {
            this.pos = pos;
            this.color = color;
            this.maxNameLength = maxChars;
        }
            ...
            GraphicsDevice graphicsDevice, ContentManager content)
        {
            ...
            rect = new Rectangle((int)pos.X, (int)pos.Y, 300, 70);
        ...
        public void update(GameTime gametime, Rectangle mousePos)
        {
            ...
            char key;
            KeysToString(keyboardState, oldKeyboardState, out key);
            text = (key.Equals((char)0) || text.Length >= maxNameLength)
                ? text : text + key;
            /*
            if (keyboardState.IsKeyUp(Keys.Back)
                && oldKeyboardState.IsKeyDown(Keys.Back)
                && text.Length != 0) */
            if (keyboardState.IsKeyUp(Keys.Back)
                && oldKeyboardState.IsKeyDown(Keys.Back)
                && text.Length != 0)
        ...
        /// <summary>
        /// Keyboard To String Method
        /// Author: Roy Triesscheijn
        /// Link: http://roy-t.nl/index.php/2010/02/11/code-snippet-converting-keyboard-input-to-text-in-xna/
        /// Date Obtained: 27/11/2015
        /// </summary>
        /// <param name="keyboard"></param>
        /// <param name="oldKeyboard"></param>
        /// <param name="key"></param>
        /// <returns></returns>
        public static bool KeysToString(KeyboardState keyboard, KeyboardState oldKeyboard, out char key)
        {
